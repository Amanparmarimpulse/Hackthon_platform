...
const ContactUS = () => {
  ...
  return (
    ...
    <Typography sx={{
       ...
       Send Invite Request For Hackthon
    </Typography>
</Container>
    <div className="container mt-5">  {/* Add container class and margin */}
      <form ref={form} onSubmit={sendEmail} className="row"> {/* Wrap form in a row */}
        <div className="col-md-6 mb-3"> {/* Define column size for each input */}
