                ...
                <AcUnitIcon sx={{color:'black'}}></AcUnitIcon>
...

                    {
                        ...
                        {/* login and sign up buttons */}
                            ...
                            <Button  sx={{marginLeft:'auto',background:'black',borderRadius:'10px' }}variant="contained" size='large'href='/login'>Login</Button>
                            <Button  sx={{marginLeft:'10px',color:'black',borderColor:'black',borderRadius:'10px'}}variant="outlined" size='large' href='/developer'>SignUP</Button>
                    </>
                        )
                    }
